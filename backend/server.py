...
PRONOTE_ENTS = {
    "none": None,  # Pas d'ENT, connexion directe
    ...
    "ac_clermont_ferrand": ac_clermont_ferrand,
    "ac_caen": ac_caen,
    "ac_bordeaux": ac_bordeaux,
    "ac_besancon": ac_besancon,
    "atrium_sud": atrium_sud,
    "cas_agora06": cas_agora06,
    "cas_arsene76": cas_arsene76,
    "cas_cybercolleges42": cas_cybercolleges42,
    "cas_kosmos": cas_kosmos,
    "cas_seinesaintdenis": cas_seinesaintdenis,
    "eclat_bfc": eclat_bfc,
    "ent_94": ent_94,
    "ent_auvergnerhonealpes": ent_auvergnerhonealpes,
    "ent_creuse": ent_creuse,
    "ent_elyco": ent_elyco,
    "ent_essonne": ent_essonne,
    "ent_hdf": ent_hdf,
    "ent_mayotte": ent_mayotte,
    "ent_somme": ent_somme,
    "ent_var": ent_var,
    "ent77": ent77,
    "extranet_colleges_somme": extranet_colleges_somme,
    "ile_de_france": ile_de_france,
    "laclasse_educonnect": laclasse_educonnect,
    "laclasse_lyon": laclasse_lyon,
    "monbureaunumerique": monbureaunumerique,
    "neoconnect_guadeloupe": neoconnect_guadeloupe,
    "occitanie_montpellier": occitanie_montpellier,
    "occitanie_toulouse": occitanie_toulouse,
    "paris_classe_numerique": paris_classe_numerique,
    "val_doise": val_doise,
}
